...
public class Raum {
    ...
    public Raum(double breiteInCm, double laengeInCm) throws Exception {
        setId(-1);
    ...
    public void setBreiteInCm(double breiteInCm){
        if(breiteInCm < 0) {
            throw new RuntimeException("Invalider Wert für Parameter breiteInCm (>0 cm!): " + breiteInCm);
        }
    ...
    public void setLaengeInCm(double laengeInCm){
        if(laengeInCm < 0) {
            throw new RuntimeException("Invalider Wert für Parameter laengeInCm (>0 cm!): " + laengeInCm);
        }
    ...
    public double getFlaecheInQm() {
        return laengeInCm/100 * breiteInCm/100;
    }
